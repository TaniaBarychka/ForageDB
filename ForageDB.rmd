...
Correlation between body masses is `r corDF`. Vif values are under 3 with 3 being a threshold suggested by Zuur et al 2009.I'll keep all the variables in the analysis for the timebeing.
